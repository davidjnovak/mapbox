...
function handlePlantClick(plant) {
    let lossValues50 = plant.lossYear50
    ...
    new Chart(ctx, {
        type: 'line',  
        data: {
            labels: Array.from({ length: lossValues50.length }, (_, i) => (i + 1).toString()),  // Just numbering the data points
            datasets: [{
                label: '50 Loss Yearly Value',
                data: lossValues50,  
                fill: false,
...
const plantData = [
    ...
    },
    {
      ...
      yearlyAcres: "5,712",
      openYear: 2016,
      potentialAcres: "45,696",
      potentialPelllets: "1,904,000",
      lat: 32.5301,
      lon: -82.3404,
      lossYear50: "[26523.45, 33283.98, 20057.8, 32880.85, 33416.03, 31062.88, 31548.58, 32671.23, 22432.41, 32724.31, 26496.71, 37244.73, 34602.19, 36870.67, 34679.73, 44772.34, 39965.43, 37016.12, 36678.42, 30619.87, 29190.24]",
      lossYear75: "[61329.88, 68191.68, 48854.72, 68088.9, 72830.79, 71451.59, 69260.32, 71654.3, 50874.44, 69215.1, 63548.92, 84741.66, 77233.37, 85907.12, 79952.84, 97627.42, 92240.73, 83480.34, 79631.72, 66620.25, 63966.5]",
      zip: 30401
    }
]